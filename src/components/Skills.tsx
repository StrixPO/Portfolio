export default function Skills() {
  return (
    <section id="skills" className="max-w-4xl mx-auto mt-24">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 text-gray-200">
        ...
        <span className="bg-gray-800 px-4 py-2 rounded">AWS (Learning)</span>
        <span className="bg-gray-800 px-4 py-2 rounded">Linux (Parrot OS)</span>
